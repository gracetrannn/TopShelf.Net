...
namespace Topshelf
{
    ...
    public static class HostConfiguratorExtensions
    {
        ...
        public static void UseAssemblyInfoForServiceInfo(this HostConfigurator hostConfigurator)
        {
            ...
            var descriptionAttribute = assembly.GetAttribute<AssemblyDescriptionAttribute>();

            // Use TryGetProperty to safely get the Description property value
            string description = descriptionAttribute.TryGetProperty(attr => attr.Description);
        }
    }
