...
namespace Topshelf.Logging
{
    ...
    public partial class LoggingExtensionsLogWriterFactory
    {
        ...
        public class LoggingExtensionsHostLoggerConfigurator : HostLoggerConfigurator
        {
            ...
            public LoggingExtensionsHostLoggerConfigurator(ILoggerFactory loggerFactory)
            {
            ...
            public LogWriterFactory CreateLogWriterFactory() => new LoggingExtensionsLogWriterFactory(this.loggerFactory);
        }
    }
}
