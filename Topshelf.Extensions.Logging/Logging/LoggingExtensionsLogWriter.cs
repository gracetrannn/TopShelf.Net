...
namespace Topshelf.Logging
{
    ...
    public class LoggingExtensionsLogWriter : LogWriter
    {
        ...
        public void Log(LoggingLevel level, object obj) =>
            _logger.Log(ToLogLevel(level), "{@LogObject}", obj);

        public void Log(LoggingLevel level, object obj, Exception exception) =>
            _logger.Log(ToLogLevel(level), exception, "{@LogObject}", obj);
        ...
        public void Info(object obj, Exception exception) =>
            _logger.LogInformation(exception, obj as string ?? "{@LogObject}", obj);
        ...
        public void Warn(object obj) => _logger.LogWarning(obj as string ?? "{@LogObject}", obj);

        public void Warn(object obj, Exception exception) =>
            _logger.LogWarning(exception, obj as string ?? "{@LogObject}", obj);
        ...
        public void Error(object obj) => _logger.LogError(obj as string ?? "{@LogObject}", obj);
        public void Error(object obj, Exception exception) =>
            _logger.LogError(exception, obj as string ?? "{@LogObject}", obj);
        ...
        public void Fatal(object obj) => _logger.LogCritical(obj as string ?? "{@LogObject}", obj);

        public void Fatal(object obj, Exception exception) =>
            _logger.LogCritical(exception, obj as string ?? "{@LogObject}", obj);
